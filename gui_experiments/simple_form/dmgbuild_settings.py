...
# Settings file for dmgbuild. run with "dmgbuild -s dmgbuild_settings.py "<volume name>" <output name>.dmg"
# Requires "pip install dmgbuild" before running the above command

application = str(Path.cwd() / "dist" / "main.app")
